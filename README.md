Unified Mixer Interface(UMI) for AudioOutputD
=============================================

Summary
-------
UMI interface for Generic Audio architecture and test harness.

Description
-----------
UMI interface with Audio connect & disconnect, volume management
for Generic Audio architecture  and test harness.
